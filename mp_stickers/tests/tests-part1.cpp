...
TEST_CASE("Image scale(0.01) scales pixel data in a reasonable way", "[weight=1][part=1]") {
  Image img = createRainbowImage();
...
TEST_CASE("Image scale(0.05) scales pixel data in a reasonable way", "[weight=1][part=1]") {
  Image img = createRainbowImage();
